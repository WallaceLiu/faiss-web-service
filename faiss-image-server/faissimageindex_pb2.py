...
_SEARCHBYEMBEDDINGREQUEST = _descriptor.Descriptor(
  ...
  full_name='faiss.SearchByEmbeddingRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='embedding', full_name='faiss.SearchByEmbeddingRequest.embedding', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='count', full_name='faiss.SearchByEmbeddingRequest.count', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
SearchByEmbeddingRequest = _reflection.GeneratedProtocolMessageType('SearchByEmbeddingRequest', (_message.Message,), dict(
  ...
  __module__ = 'faissimageindex_pb2'
  # @@protoc_insertion_point(class_scope:faiss.SearchByEmbeddingRequest)
  ))
...
_IMAGEINDEX = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='faiss.ImageIndex.SearchByEmbedding',
    index=3,
    containing_service=None,
